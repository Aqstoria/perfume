      ...
      <div className="max-w-4xl mx-auto">
        ...
        {result && (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <pre className="bg-gray-100 p-4 rounded text-sm overflow-auto max-h-96">{result}</pre>
          </div>
        )}
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-6">
          ...
          <ul className="text-yellow-700 text-sm space-y-1">
            <li>
              • <strong>Migrations:</strong> Applies pending migration files to the database
            </li>
            <li>
              • <strong>Push:</strong> Pushes the current schema directly to the database (may reset
              data)
            </li>
            <li>
              • <strong>Seed:</strong> Runs the database seeding script
            </li>
